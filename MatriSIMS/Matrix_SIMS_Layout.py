...
# Form implementation generated from reading ui file 'Matrix_SIMS_Layout.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_inde_variable_3.setGeometry(QtCore.QRect(20, 322, 121, 16))
        ...
        self.label_inde_variable_2.setGeometry(QtCore.QRect(20, 262, 121, 16))
        self.label_inde_variable_2.setObjectName("label_inde_variable_2")
        self.lineEdit_inde_variable_2 = QtWidgets.QLineEdit(self.tabAnalyses_type)
        self.lineEdit_inde_variable_2.setEnabled(False)
        self.lineEdit_inde_variable_2.setGeometry(QtCore.QRect(150, 260, 113, 21))
        self.lineEdit_inde_variable_2.setObjectName("lineEdit_inde_variable_2")
        self.label_inde_variable_1 = QtWidgets.QLabel(self.tabAnalyses_type)
        self.label_inde_variable_1.setGeometry(QtCore.QRect(20, 202, 121, 16))
        self.label_inde_variable_1.setObjectName("label_inde_variable_1")
        self.lineEdit_inde_variable_3 = QtWidgets.QLineEdit(self.tabAnalyses_type)
        self.lineEdit_inde_variable_3.setEnabled(False)
        self.lineEdit_inde_variable_3.setGeometry(QtCore.QRect(150, 320, 113, 21))
        self.lineEdit_inde_variable_3.setObjectName("lineEdit_inde_variable_3")
        self.lineEdit_inde_variable_1 = QtWidgets.QLineEdit(self.tabAnalyses_type)
        self.lineEdit_inde_variable_1.setGeometry(QtCore.QRect(150, 200, 113, 21))
        self.lineEdit_inde_variable_1.setObjectName("lineEdit_inde_variable_1")
        ...
        self.lineEdit_target_variable = QtWidgets.QLineEdit(self.tabAnalyses_type)
        self.lineEdit_target_variable.setGeometry(QtCore.QRect(170, 60, 113, 21))
        self.lineEdit_target_variable.setObjectName("lineEdit_target_variable")
        self.lineEdit_error_variable_1 = QtWidgets.QLineEdit(self.tabAnalyses_type)
        self.lineEdit_error_variable_1.setEnabled(False)
        self.lineEdit_error_variable_1.setGeometry(QtCore.QRect(150, 229, 113, 21))
        self.lineEdit_error_variable_1.setObjectName("lineEdit_error_variable_1")
        self.label_error_variable_1 = QtWidgets.QLabel(self.tabAnalyses_type)
        self.label_error_variable_1.setEnabled(False)
        self.label_error_variable_1.setGeometry(QtCore.QRect(20, 232, 121, 16))
        self.label_error_variable_1.setObjectName("label_error_variable_1")
        self.lineEdit_error_variable_2 = QtWidgets.QLineEdit(self.tabAnalyses_type)
        self.lineEdit_error_variable_2.setEnabled(False)
        self.lineEdit_error_variable_2.setGeometry(QtCore.QRect(150, 289, 113, 21))
        self.lineEdit_error_variable_2.setObjectName("lineEdit_error_variable_2")
        self.label_error_variable_2 = QtWidgets.QLabel(self.tabAnalyses_type)
        self.label_error_variable_2.setEnabled(False)
        self.label_error_variable_2.setGeometry(QtCore.QRect(20, 292, 121, 16))
        ...
        self.label_error_variable_3.setGeometry(QtCore.QRect(20, 352, 121, 16))
        self.label_error_variable_3.setObjectName("label_error_variable_3")
        self.lineEdit_error_variable_3 = QtWidgets.QLineEdit(self.tabAnalyses_type)
        self.lineEdit_error_variable_3.setEnabled(False)
        self.lineEdit_error_variable_3.setGeometry(QtCore.QRect(150, 349, 113, 21))
        self.lineEdit_error_variable_3.setObjectName("lineEdit_error_variable_3")
        ...
        self.lineEdit_target_error_variable = QtWidgets.QLineEdit(self.tabAnalyses_type)
        self.lineEdit_target_error_variable.setGeometry(QtCore.QRect(170, 88, 113, 21))
        self.lineEdit_target_error_variable.setText("")
        self.lineEdit_target_error_variable.setObjectName("lineEdit_target_error_variable")
        self.label_target_error_variable = QtWidgets.QLabel(self.tabAnalyses_type)
        self.label_target_error_variable.setGeometry(QtCore.QRect(20, 90, 141, 16))
