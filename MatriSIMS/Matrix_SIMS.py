...
## Define all connections for the GUI
    ...
    def home(self):
        ...
        self.lineEdit_target_variable.editingFinished.connect(self.target_variable)
        self.lineEdit_target_error_variable.editingFinished.connect(self.target_error_variable)
        self.lineEdit_inde_variable_1.editingFinished.connect(self.var1_name_iso)
        self.lineEdit_inde_variable_2.editingFinished.connect(self.var2_name_iso)
        self.lineEdit_inde_variable_3.editingFinished.connect(self.var3_name_iso)
        self.lineEdit_error_variable_1.editingFinished.connect(self.error1_name_iso)
        self.lineEdit_error_variable_2.editingFinished.connect(self.error2_name_iso)
        self.lineEdit_error_variable_3.editingFinished.connect(self.error3_name_iso)
...
## Define all actions for each interaction with the GUI
    ...
    def target_variable(self):
        global target_name
        target_name = None
        target_name_str = self.lineEdit_target_variable.text()
        target_name = str(target_name_str) 

    def target_error_variable(self):
        global target_error_name
        target_error_name = None
        target_error_name_str = self.lineEdit_target_error_variable.text()
        target_error_name = str(target_error_name_str)        

    def var1_name_iso(self):
        global var1_name
        var1_name = None
        var1_name_str = self.lineEdit_inde_variable_1.text()
        var1_name = str(var1_name_str)

    def var2_name_iso(self):
        global var2_name
        var2_name = None
        var2_name_str = self.lineEdit_inde_variable_2.text()
        var2_name = str(var2_name_str)

    def var3_name_iso(self):
        global var3_name
        var3_name = None
        var3_name_str = self.lineEdit_inde_variable_3.text()
        var3_name = str(var3_name_str)

    def error1_name_iso(self):
        global error1_name
        error1_name = None
        error1_name_str = self.lineEdit_error_variable_1.text()
        error1_name = str(error1_name_str)

    def error2_name_iso(self):
        global error2_name
        error2_name = None
        error2_name_str = self.lineEdit_error_variable_2.text()
        error2_name = str(error2_name_str)

    def error3_name_iso(self):
        global error3_name
        error3_name = None
        error3_name_str = self.lineEdit_error_variable_3.text()
